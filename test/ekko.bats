...
@test "$(ekko b history_help): Echo a block of text without title" {
...
@test "$(ekko b help): Echo a block of text with a title" {
...
@test "$(ekko b help): Echo a block of text without title" {
  run ekko help <<HELP
#ekko msg # line4
line1
line2
